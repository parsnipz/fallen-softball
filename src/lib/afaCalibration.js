...
export async function createCalibrationPDF() {
  ...
  const fields = [
    ...
    // Manager address
    { name: 'Mgr Addr', x: 70, fromTop: 150 },
    { name: 'Mgr Sig', x: 630, fromTop: 150 },
    // Player row 1
    { name: 'P1 Name', x: 61, fromTop: 201 },
    { name: 'P1 DOB', x: 230, fromTop: 201 },
    { name: 'P1 Addr', x: 284, fromTop: 201 },
    { name: 'P1 Sig', x: 630, fromTop: 201 },
    // Player row 2 (to show row spacing)
    { name: 'P2 Name', x: 61, fromTop: 220 },
    // Coach row 1
